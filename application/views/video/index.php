                    ...
                    <div class="titleBar">
                        ...
                        <div class="searchbox">
                            <form action="http://zhannei.baidu.com/cse/search" method="get" target="_blank">
                                ...
                                <span class="holderBox" style="position:relative;zoom:1;overflow:hidden;display:inline-block;float:left"><input type="text" name="q" id="inputSearch" class="searchinpt" data-holder="请输入关键字"><span class="holder" style="font-size: 16px; top: 0px; line-height: 34px; position: absolute; left: 10px; color: rgb(204, 204, 204); display: block; width: 227px;">请输入关键字</span></span>
